            ...
            <div class="w-100 h-100 d-flex">
                <div class="mt-5 mx-3" style={{border:'2px solid #2F528F',borderRadius:'10px',width:'20vw'}}>
                        <div style={{display:'flex', justifyContent:'Center',
                                    ...
                                    alignItems: 'center'}}>
                            <div class="mt-3 card d-flex " style={{borderRadius:'10px',width:'17vw',height:'5vh',backgroundColor:'#AE78D6'}}>
                                <div class="mt-2 d-flex justify-content-center text-center " style={{width:'100%',height:'7vh',}}>
                                  <p class=" d-flex justify-content-center text-center" style={{fontSize:'20px',height:'5vh'}}><dt>ข้อมูลการอบรม/สัมมนา/ดูงาน</dt></p>
                                </div>
                            </div>
