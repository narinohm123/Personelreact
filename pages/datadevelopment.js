                        ...
                        <div style={{display:'flex', justifyContent:'Center',
                            ...
                            <div class="mt-3 card d-flex " style={{borderRadius:'10px',width:'15vw',height:'5vh',backgroundColor:'#AE78D6'}}>
                                <div class="mt-2 d-flex justify-content-center text-center " style={{width:'100%',height:'7vh',}}>
                                  <p class=" d-flex justify-content-center text-center" style={{fontSize:'20px',height:'5vh'}}><dt>แผนพัฒนาบุคลากร</dt></p>
                                </div>
                            </div>
                            <div class="mt-3" style={{display: 'flex',flexDirection: 'column',width:'10vw'}}>
                               <button type="button" class="btn btn-outline-dark">2554-2557</button>
                               <button type="button" class="btn btn-outline-dark">2559-2562</button>
                               <button type="button" class="btn btn-outline-dark">2563-2566</button>
                            </div>
                        </div> 
                    </div>
                <div>
