                        ...
                        <div style={{display:'flex', justifyContent:'Center',
                            ...
                            <div class="mt-3 card d-flex " style={{borderRadius:'10px',width:'16vw',height:'5vh',backgroundColor:'#AE78D6'}}>
                                <div class="mt-2 d-flex justify-content-center text-center " style={{width:'100%',fontSize:'20px',height:'7vh',flexDirection: 'column',alignItems: 'center'}}>
                                  <p class="" style={{height:'3vh'}}><dt>ผู้ดำรงตำแหน่งทางวิชาการ</dt></p>
                                </div>
                            </div>
                            <div class="mt-3" style={{display: 'flex',flexDirection: 'column',width: '14vw'}}>
                                <button type="button" class="btn btn-outline-dark">อนุมัติตำแหน่งทางวิชาการ</button>
                                <button type="button" class="btn btn-outline-dark">ไม่อนุมัติตำแหน่งทางวิชาการ</button>
                            </div>
                        </div> 
                    </div>
                <div>
